...
const fishes = {
  fish1: {
    ...
    image: `${process.env.PUBLIC_URL}/images/hali.jpg`,
  ...
  fish2: {
    name: 'Lobster',
    image: `${process.env.PUBLIC_URL}/images/lobster.jpg`,
  ...
  fish3: {
    name: 'Sea Scallops',
    image: `${process.env.PUBLIC_URL}/images/scallops.jpg`,
  ...
  fish4: {
    name: 'Mahi Mahi',
    image: `${process.env.PUBLIC_URL}/images/mahi.jpg`,
  ...
  fish5: {
    name: 'King Crab',
    image: `${process.env.PUBLIC_URL}/images/crab.jpg`,
  ...
  fish7: {
    name: 'Oysters',
    image: `${process.env.PUBLIC_URL}/images/oysters.jpg`,
  ...
  fish8: {
    name: 'Mussels',
    image: `${process.env.PUBLIC_URL}/images/mussels.jpg`,
  ...
  fish9: {
    name: 'Jumbo Prawns',
    image: `${process.env.PUBLIC_URL}/images/prawns.jpg`,
